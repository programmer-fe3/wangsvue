    ...
    <div :ref="containerRef" class="layout-topbar">
        <div class="layout-topbar-inner">
            <div class="layout-topbar-logo-container">
                <WangsVueNuxtLink to="/" class="layout-topbar-logo" aria-label="wangsVue logo">
                ...
                <WangsVueNuxtLink to="/" class="layout-topbar-icon" aria-label="wangsVue logo">
            ...
            <ul class="topbar-items">
                ...
                <li>
                    <a href="https://github.com/wangsfaces/wangsvue" target="_blank" rel="noopener noreferrer" class="topbar-item">
                ...
                <li>
                    <a href="https://github.com/orgs/wangsfaces/discussions" target="_blank" rel="noopener noreferrer" class="topbar-item">
                    ...
                    <div class="versions-panel hidden">
                        <ul>
                            <li v-for="version in versions" :key="version.version" role="none">
                                <a :href="version.url">
                                    <span>wangsVue {{ version.name }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    data() {
        return {
            versions: [
                {
                    name: 'v4',
                    url: 'https://wangsvue.org'
                },
                {
                    name: 'v3',
                    url: 'https://v3.wangsvue.org'
                },
                {
                    name: 'v2',
                    url: 'https://www.wangsfaces.org/wangsvue-v2'
                }
            ]
        };
    },
