<template>
    <div>
        <Head>
            <Title>UI Kit - wangsVue</Title>
            <Meta name="description" content="Design files for wangsVue Components." />
        </Head>

        <div>
            <div style="border-radius: 50px; max-height: 500px" class="overflow-hidden mb-8 flex items-center">
                <img alt="wangsVue Designer" :src="coverImage" class="w-full" />
            </div>

            <div class="card mb-8" style="border-radius: 50px">
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        <img alt="wangsVue UI Kit" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/uikit-figma.png" class="w-full" />
                    </div>
                    <div class="w-full md:w-6/12">
                        <div class="text-primary font-bold mb-2">UP-TO-DATE</div>
                        <div class="text-5xl font-bold mb-4">Best Features of Figma</div>
                        <p class="mb-4 text-lg">wangsOne for Figma uses the latest powerful features like components, variants, auto layout, styles and interactive components. It'll always follow the best practices.</p>
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        ...
                        <p class="mb-4 text-lg">Save countless hours on every project with a carefully designed system that uses wangs UI Suite components. Start producing design results in no time.</p>
                    ...
                    <div class="w-full md:w-6/12">
                        <img alt="wangsVue Designer" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/uikit-system.png" class="w-full" />
                    </div>
                </div>
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20 mb-20">
                    <div class="w-full md:w-6/12">
                        <img alt="wangsVue Designer" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/uikit-themes.png" class="w-full" />
                    </div>
                    <div class="w-full md:w-6/12">
                        <div class="text-primary font-bold mb-2">DARK MODE</div>
                        <div class="text-5xl font-bold mb-4">Two Themes</div>
                        <p class="mb-4 text-lg">wangsOne is designed based on Lara Blue Light and Lara Blue Dark themes. Easily change the themes of your designs using Figma's Swap Library feature.</p>
                ...
                <div class="flex flex-col md:flex-row items-center gap-6 md:gap-20">
                    ...
                    <div class="w-full md:w-6/12">
                        <img alt="Tokens Support" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/uikit-tokens.png" class="w-full" />
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 md:gap-20 mb-8">
                <a
                    href="https://www.figma.com/file/96Tql1EywmMtVlSFTkQ2MB/Preview-%7C-wangsOne-%7C-2.2.0?type=design&node-id=806%3A36648&mode=design&t=CPR8n1g9WLc5D2Hs-1"
                ...
                >
                    ...
                    <img alt="Figma Light" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/logo-figma-light.svg" class="w-16" />
                </a>
                <a
                    href="https://www.figma.com/file/ujRD6FFCWw1bE0h4wIebxl/Preview-%7C-Dark-%7C-wangsOne-%7C-2.2.0?type=design&node-id=806%3A36648&mode=design&t=bG7aorZhOFIqX1qz-1"
                ...
                >
                    ...
                    <img alt="Figma Dark" src="https://wangsfaces.org/cdn/wangsvue/images/uikit/logo-figma-dark.svg" class="w-16" />
                </a>
            </div>
            ...
            <div class="card mb-8" style="border-radius: 50px">
                ...
                <div class="text-center mb-8">
                    <a href="https://www.wangsfaces.org/uikit/licenses" class="doc-link">View License Details</a>
                </div>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a v-ripple href="https://www.wangsfaces.org/store/uikit.xhtml" class="bg-blue-500 text-white hover:bg-blue-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 h-full flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <a v-ripple href="https://www.wangsfaces.org/store/uikit.xhtml" class="bg-purple-500 text-white hover:bg-purple-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div class="p-4 h-full">
                            <div class="shadow p-8 flex flex-col bg-surface-0 dark:bg-surface-900" style="border-radius: 6px">
                                ...
                                <hr class="mb-4 mx-0 border-t border-0 border-surface-200 dark:border-surface-700" />
                                <a v-ripple href="mailto:contact@wangstek.com.tr" class="bg-gray-500 text-white hover:bg-gray-400 p-4 w-full rounded text-center transition-colors duration-300 font-bold p-ripple">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card" style="border-radius: 50px">
                ...
                <div class="grid grid-cols-12 gap-4 text-lg">
                    ...
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <p class="mt-0 mb-12 p-0 leading-normal">At wangsStore, you have the option to purchase an additional update term. This will grant you access to all existing versions and updates for another year.</p>

                        <div class="leading-normal mb-2 font-bold">How can I get support?</div>
                        <p class="mt-0 mb-12 p-0 leading-normal">
                            wangsTek offers assistance with account management and licensing issues, with the expectation that users have the necessary technical knowledge to use our products, as we do not offer technical support or consulting. Users
                            ...
                            <a href="https://github.com/orgs/wangsfaces/discussions/categories/figma-ui-kit" class="doc-link">Forum</a>.
                        </p>
                    </div>
                    <div class="col-span-12 lg:col-span-4 px-2 lg:px-8">
                        ...
                        <p class="mt-0 mb-12 p-0 leading-normal">Yes, after the purchase, please <a href="mailto:contact@wangstek.com.tr" class="doc-link">contact us</a> so we can transfer the license to your client.</p>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        coverImage() {
            const image = this.$appState.darkTheme ? 'images/uikit/wangsone-cover-dark.jpeg' : 'images/uikit/wangsone-cover-light.jpeg';

            return 'https://wangsfaces.org/cdn/wangsvue/' + image;
        }
    }
};
</script>
