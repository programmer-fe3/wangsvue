    ...
    data() {
        return {
            atlantisData: {
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                logo: AtlantisLogo,
                                pattern: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-hero-pattern.png',
                                dashboard1: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-hero-dashboard1.png',
                                dashboard2: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-hero-dashboard2.png',
                                description: 'Prepare to be amazed by the remastered Atlantis for wangsVue featuring a new gorgeous dark mode for the entire layout, 5 menu modes, reusable css widgets, utilities, modern icons and many more.',
                                liveHref: 'https://www.wangsfaces.org/atlantis-vue/',
                                docHref: 'https://www.wangsfaces.org/atlantis-vue/documentation/',
                                pattern: {
                                    className: 'select-none absolute md:-bottom-28 bottom-36 -left-20 md:-left-28 z-[6] md:w-[50rem] h-auto w-[60rem] opacity-75',
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-hero-pattern.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://atlantis.wangsvue.org/documentation',
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/features-animation-darkmode.png'
                                },
                                {
                                    id: 2,
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/features-animation-component-themes.png'
                                },
                                {
                                    id: 3,
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/features-animation-orientations.png',
                                    type: 'inline-animation',
                                    inlineFeaturesData: [
                                        {
                                            id: 1,
                                            title: 'Static',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Static.png'
                                        },
                                        {
                                            id: 2,
                                            title: 'Slim',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Slim.png'
                                        },
                                        {
                                            id: 3,
                                            title: 'Reveal',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Reveal.png'
                                        },
                                        {
                                            id: 4,
                                            title: 'Horizontal',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Horizontal.png'
                                        },
                                        {
                                            id: 5,
                                            title: 'Overlay',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Overlay.png'
                                        },
                                        {
                                            id: 6,
                                            title: 'Slim+',
                                        ...
                                        },
                                        {
                                            id: 7,
                                            title: 'Drawer',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/Drawer.png'
                                        }
                                    ]
                                }
                            ]
                        ...
                        props: {
                            featuresData: [
                                ...
                                },
                                {
                                    id: 3,
                                    title: 'wangsIcons',
                                    description: 'Atlantis ships with wangsIcons, wangsTek’s modern icon library including a wide range of icons for your applications.',
                                ...
                                },
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/features-animation-figma.png'
                                }
                            ]
                        },
                        slots: {
                ...
                <a href="https://www.figma.com/file/two0OGwOwHfq0sdjeK34l0/Preview-%7C-Atlantis-2022?node-id=15%3A1427&t=2lNJ5EzW0xuvQWdm-1">preview the Figma file</a> before the purchase. Note that wangsVue UI components are excluded from the
                Atlantis Figma file as they are available in <WangsVueNuxtLink to="/uikit">wangsOne for Figma</WangsVueNuxtLink> only.`
                        }
                    },
                    {
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-features2-responsive.png'
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-features2-ready.png'
                                },
                                {
                                    title: 'Mobile Experience',
                                    description: 'Touch optimized enhanced mobile experience with responsive design.',
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/atlantis/atlantis-features2-mobile.png'
                                }
                            ],
