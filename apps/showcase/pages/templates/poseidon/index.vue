                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                logo: PoseidonLogo,
                                pattern: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/hero-background.png',
                                dashboard1: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/poseidon-hero-dashboard1.png',
                                dashboard2: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/poseidon-hero-dashboard2.png',
                                ...
                                liveHref: 'https://poseidon.wangsvue.org',
                                docHref: 'https://poseidon.wangsvue.org/documentation',
                                pattern: {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/hero-background.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://poseidon.wangsvue.org/documentation/',
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-darkmode.png'
                                },
                                {
                                    id: 2,
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-component-themes.png'
                                },
                                {
                                    id: 3,
                                    title: '3 Menu Orientations',
                                    description: 'Poseidon has 3 menu layouts to choose from; Static, Overlay and Horizontal.',
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-orientations.png',
                                    type: 'inline-animation',
                                    inlineFeaturesData: [
                                        {
                                            id: 1,
                                            title: 'Static',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/Static.png'
                                        },
                                        {
                                            id: 2,
                                            title: 'Overlay',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/Overlay.png'
                                        },
                                        {
                                            id: 3,
                                            title: 'Horizontal',
                                            src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/Horizontal.png'
                                        }
                                    ]
                                }
                            ]
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-utilities.png'
                                },
                                {
                                    id: 2,
                                    title: 'wangsBlocks',
                                    description: 'Fully compatible with wangsBlocks, choose from the wide range of blocks and customize the way you like. Note that wangsBlocks is not included in the template and requires a separate purchase.',
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-blocks.png'
                                },
                                {
                                    id: 3,
                                    title: 'wangsIcons',
                                    description: 'Poseidon ships with wangsIcons, wangsTek’s modern icon library including a wide range of icons for your applications.',
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/features-animation-icons.png'
                                }
                            ]
                        },
                        slots: {
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/poseidon/poseidon-features2-responsive.png'
                                },
                                {
                                    title: 'Support',
                                ...
                                },
                                {
                                    ...
                                    src: 'https://wangsfaces.org/cdn/wangsvue/images/templates/apollo/apollo-features2-mobile.png'
                                }
                            ],
