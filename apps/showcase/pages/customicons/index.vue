<template>
    <div>
        <Head>
            ...
            <Meta name="description" content="wangsVue components can be used with any icon library using the templating features." />
        </Head>
        ...
        <div class="doc">
            <div class="doc-main">
                <div class="doc-intro">
                    <h1>Custom Icons</h1>
                    <p>wangsVue components can be used with any icon library using the templating features.</p>
                </div>
