<template>
    <div>
        <Head>
            <Title>Accessibility - wangsVue</Title>
        ...
        <div class="doc">
            <div class="doc-main">
                <div class="doc-intro">
                    <h1>Accessibility</h1>
                    <p>wangsVue has WCAG 2.1 AA level compliance, refer to the accessibility documentation of each component for detailed information.</p>
                </div>
