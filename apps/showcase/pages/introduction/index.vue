<template>
    <Head>
        <Title>Introduction - wangsVue</Title>
        ...
        <div class="doc-main">
            <div class="doc-intro">
                <div style="border-radius: 20px; max-height: 640px" class="overflow-hidden mb-8 flex items-center">
                    <img alt="wangsVue Designer" :src="introDesktopImg" class="w-full hidden md:block" />
                    <img alt="wangsVue Designer" :src="introMobileImg" class="w-full md:hidden" />
                </div>
                <h1>Introduction</h1>
...
export default {
    ...
    computed: {
        introDesktopImg() {
            return `https://wangsfaces.org/cdn/wangsvue/images/overview${this.$appState.darkTheme ? '-dark' : ''}.png`;
        },
        introMobileImg() {
            return `https://wangsfaces.org/cdn/wangsvue/images/overview${this.$appState.darkTheme ? '-dark' : ''}-mobile.png`;
        }
    }
};
</script>
