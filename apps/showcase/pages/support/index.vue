    ...
    <div>
        <div class="flex flex-col md:flex-row mb-8 gap-8">
            <div class="card flex-1 !m-0 relative overflow-hidden">
                ...
                <p class="m-0 leading-normal relative text-lg">
                    <a href="https://github.com/orgs/wangsfaces/discussions" class="doc-link" target="_blank" rel="noopener noreferrer">Forum</a> and
                    ...
                    channel for the community users to create tickets however wangsTek does not guarantee a response time although they are monitored and maintained by our staff. If you need to secure a response, you may consider PRO support instead.
                </p>
            </div>
            <div class="card !m-0 flex-1 !bg-primary !text-primary-contrast font-medium">
                ...
                <p class="m-0 leading-normal text-lg">
                    With PRO support, it's easy to support, tune, and add features to wangsVue as an in-house library. With the exclusive services of a PRO account, you no longer need to post questions in the community forum and the community issue
        ...
        <div class="grid grid-cols-3 gap-8 mb-8">
            <div class="card !m-0 col-span-full lg:col-span-1">
                ...
                <a
                    href="mailto:wangstek.com.tr?subject=wangsVue%20PRO%20Support"
            ...
            <div class="card !m-0 col-span-full lg:col-span-2">
                ...
                <ul class="flex flex-col gap-4 list-none m-0 p-0 text-lg">
                    <li>
                        ...
                        <span class="leading-normal">Contact <a href="mailto:contact@wangstek.com.tr" target="_blank" rel="noopener noreferrer" class="doc-link">wangsTek</a> to purchase support.</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="leading-normal">An estimate is provided to resolve the issue, upon your approval the wangsTek team commences work.</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="leading-normal"
                            >If the issue requires an update in the library, it gets published to npm by as part of the public wangsVue package. A patch update on an older version can also be requested if you are not using the latest version.
                        </span>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex flex-col md:flex-row text-lg gap-8">
                ...
                <div class="flex-1 flex flex-col gap-8">
                    <div>
                        ...
                        <p class="!m-0 leading-normal">No, changes become part of the wangsVue core and pushed to the public npm package on next update.</p>
                    </div>
                    <div>
                        <div class="leading-normal mb-2 font-semibold">Who provides the support service?</div>
                        <p class="!m-0 leading-normal">Support service is provided by the wangsVue team at wangsTek.</p>
                    </div>
                    <div>
                ...
                <div class="flex-1 flex flex-col gap-8">
                    <div>
                        ...
                        <p class="!m-0 leading-normal">Yes, initially the request needs to be approved by wangsTek based on project roadmap fit. As a result, not all requests may be accepted.</p>
                    </div>
                    <div>
