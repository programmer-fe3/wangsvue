<template>
    <div>
        <Head>
            <Title>wangsVue Roadmap</Title>
            <Meta name="description" content="wangsVue Roadmap" />
        </Head>

        <div class="doc-intro">
            <h1>Roadmap</h1>
            <p>
                At <a href="https://www.wangstek.com.tr/">wangsTek</a>, we are passionate about improving wangsVue and would like to share our ideas for 2024 with the community. These are planned to be implemented in parallel to the regular
                maintenance work of the library involving review of issue tickets, PRs and wangsVue PRO support.
            </p>
        </div>
        ...
        <div class="overflow-auto">
            <div style="min-width: 1200px">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-4 border-b border-surface-200 dark:border-surface-700 pb-4">
                        ...
                        <div class="flex-1 flex gap-4 flex-col">
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 rounded border-violet-500 border-l-8">
                                ...
                                <p class="mt-0 mb-4 leading-normal">Update all templates to wangsVue v4, replace wangsFlex demos with Tailwind.</p>
                                <div class="bg-surface-200 rounded">
                                    <div class="bg-teal-500 rounded" style="width: 0%; height: 4px"></div>
                                </div>
                            </div>
                    ...
                    <div class="flex gap-4 border-b border-surface-200 dark:border-surface-700 pb-4">
                        <div class="shrink-0 p-4 bg-orange-500 text-white rounded font-bold text-lg flex items-center justify-center w-56">wangsBlocks</div>
                        <div class="flex-1 flex gap-4 flex-col"></div>
                        <div class="flex-1 flex gap-4 flex-col">
