<template>
    <div>
        <Head>
            <Title>Unstyled - wangsVue</Title>
            <Meta name="description" content="Styling wangsVue with your favorite CSS library." />
        </Head>
        ...
        <div class="doc">
            <div class="doc-main">
                <div class="doc-intro">
                    <h1>Unstyled Mode</h1>
                    <p>Styling wangsVue with your favorite CSS library.</p>
                </div>
