<template>
    <div>
        <Head>
            <Title>Styled Mode - wangsVue</Title>
        ...
        return {
            docs: [
                ...
                },
                {
                    id: 'csslayer',
                    label: 'CSS Layer',
                    description: 'The wangsVue CSS layer only applies to styled mode when layering is enabled explicitly at theme configuration, in unstyled mode the built-in CSS classes are not included and as a result no layer is necessary.',
                    children: [
                        {
                            id: 'specificity',
                            label: 'Specificity',
