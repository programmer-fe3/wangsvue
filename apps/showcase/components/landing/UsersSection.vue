<template>
    <section class="landing-users py-20 px-4 lg:px-20">
        ...
        <p class="section-detail">
            wangsTek libraries have reached over <span class="font-semibold animated-text relative whitespace-nowrap"> <span>150 Million Downloads </span> </span> on npm! Join the wangsLand community and experience the difference yourself.
        </p>
        <div class="flex justify-center items-center mt-6">
            <span class="ml-2"> </span>
        </div>
        <div v-for="(x, i) in users" :key="i" class="logo-section relative w-full md:w-8/12 mt-12 users-container">
...
export default {
    ...
    methods: {
        imgSrc(brand) {
            return `https://wangsfaces.org/cdn/wangsvue/images/landing/whouses/${brand}-${this.colorScheme}.svg`;
        }
    },
    computed: {
        colorScheme() {
