        ...
        <div class="landing-footer-container">
            <div class="flex flex-wrap z-10">
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <WangsVueNuxtLink to="/setup" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300">Get Started</WangsVueNuxtLink>
                        </li>
                        <li class="mb-6">
                            <a href="https://github.com/wangsfaces/wangsvue-examples" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer"
                                >Examples</a
                            >
                        </li>
                    </ul>
                ...
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <a href="https://github.com/orgs/wangsfaces/discussions" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Forum</a>
                        </li>
                        <li class="mb-6">
                        ...
                        <li class="mb-6">
                            <WangsVueNuxtLink to="/support" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300">PRO Support</WangsVueNuxtLink>
                        </li>
                    </ul>
                </div>
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <WangsVueNuxtLink to="/theming/styled" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300">Styled Mode</WangsVueNuxtLink>
                        </li>
                        <li class="mb-6">
                            <WangsVueNuxtLink to="/theming/unstyled" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300">Unstyled Mode</WangsVueNuxtLink>
                        </li>
                    </ul>
                </div>
                <div class="w-6/12 lg:w-3/12 flex">
                    <ul class="list-none p-0 m-0">
                        ...
                        <li class="mb-6">
                            <a href="https://www.wangsfaces.org/store/" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Store</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://github.com/wangsfaces/wangsvue" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Source Code</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://twitter.com/wangsvue" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Twitter</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://www.wangsfaces.org/newsletter" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">Newsletter</a>
                        </li>
                        <li class="mb-6">
                            <a href="https://gear.wangsfaces.org/" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300" target="_blank" rel="noopener noreferrer">wangsGear</a>
                        </li>
                        <li class="mb-6">
                            <a href="mailto:contact@wangstek.com.tr" class="text-surface-500 dark:text-surface-400 font-medium hover:text-primary rounded transition-all duration-300">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-wrap justify-between py-12 gap-8">
                ...
                <div class="flex items-center gap-2">
                    <a href="https://twitter.com/wangsvue" class="linkbox linkbox-icon">
                        <i class="pi pi-twitter"></i>
                    </a>
                    <a href="https://github.com/wangsfaces/wangsvue" class="linkbox linkbox-icon">
                        <i class="pi pi-github"></i>
                    </a>
                    <a href="https://discord.gg/gzKFYnpmCY" class="linkbox linkbox-icon">
                        <i class="pi pi-discord"></i>
                    </a>
                    <a href="https://github.com/orgs/wangsfaces/discussions" class="linkbox linkbox-icon">
