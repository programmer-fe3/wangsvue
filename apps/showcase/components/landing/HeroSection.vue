    ...
    <section class="landing-hero py-20 px-8 lg:px-20">
        <div class="flex flex-col items-center">
            ...
            <p class="text-center mt-0 mb-8 text-surface-500 dark:text-surface-400 font-medium text-xl leading-relaxed lg:px-56">
                Enhance your web applications with wangsVue's comprehensive suite of customizable, feature-rich UI components. With wangsVue, turning your development vision into reality has never been easier.
            </p>
            <div class="flex items-center gap-4">
                <WangsVueNuxtLink to="/setup" class="linkbox linkbox-primary">
                    <span>Get Started </span>
                    <i class="pi pi-arrow-right ml-4"></i>
                </WangsVueNuxtLink>
                <a href="https://github.com/wangsfaces/wangsvue" target="_blank" rel="noopener noreferrer" class="linkbox">
            ...
            <div :class="isSlimMenu ? 'w-auto' : 'w-72'" class="rounded-2xl p-5 bg-surface-50 dark:bg-surface-900 h-full flex flex-col justify-between">
                <div :class="isSlimMenu ? 'w-12 flex flex-col items-center' : 'w-auto'">
                    <div class="flex items-center gap-3">
                        ...
                        <div :class="isSlimMenu ? 'hidden' : 'block'" class="text-surface-950 dark:text-surface-0 font-medium text-3xl">wangs</div>
                    </div>
                ...
                <div :class="isSlimMenu ? 'w-12 flex flex-col items-center' : 'w-auto'">
                    ...
                    <div :class="isSlimMenu ? 'justify-center' : ' gap-3'" class="flex items-center">
                        <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/main-avatar.png" size="large" shape="circle" class="shrink-0" />
                        <div>
...
export default {
    data() {
        return {
            ...
            sampleOptions: [
                { icon: 'pi pi-home', title: 'Overview', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/overview' },
                { icon: 'pi pi-comment', title: 'Chat', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/chat' },
                { icon: 'pi pi-inbox', title: 'Inbox', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/mail' },
                { icon: 'pi pi-th-large', title: 'Cards', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/cards' },
                { icon: 'pi pi-user', title: 'Customers', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/customers' },
                { icon: 'pi pi-video', title: 'Movies', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/movies' }
            ],
            selectedSampleOption: { icon: 'pi pi-home', title: 'Overview', src: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/sampleshots/overview' }
        };
    } /*,
    beforeUnmount() {
