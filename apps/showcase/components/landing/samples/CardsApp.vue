            ...
            <div class="flex-1 flex flex-col gap-6">
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    <div class="flex items-center gap-3">
                        <OverlayBadge severity="danger" class="w-fit">
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/main-avatar.png" size="large" class="rounded-lg overflow-hidden flex" />
                        </OverlayBadge>
                        <div>
                    ...
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <AvatarGroup>
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar1.png" size="small" class="rounded-lg overflow-hidden" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar9.jpg" size="small" class="rounded-lg overflow-hidden" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg" size="small" class="rounded-lg overflow-hidden" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar13.jpg" size="small" class="rounded-lg overflow-hidden" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png" size="small" class="rounded-lg overflow-hidden" />
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="p-2 rounded-2xl flex items-center gap-3 bg-emphasis">
                            <OverlayBadge severity="danger" class="w-fit">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/main-avatar.png" class="rounded-lg overflow-hidden w-10 h-10 block" />
                            </OverlayBadge>
                            <div class="flex-1">
                        ...
                        <div class="p-2 rounded-2xl flex items-center gap-3 bg-emphasis">
                            <OverlayBadge severity="danger" class="w-fit">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar9.jpg" class="rounded-lg overflow-hidden w-10 h-10 flex" />
                            </OverlayBadge>
                            <div class="flex-1">
                ...
                <div class="border border-surface rounded-3xl p-6">
                    <div class="flex items-center gap-3 p-3 border border-surface rounded-xl shadow-[0px_1px_2px_0px_rgba(18,18,23,0.05)]">
                        <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/main-avatar.png" class="rounded-lg overflow-hidden w-14 h-14" />
                        <div class="flex-1">
                    ...
                    <div class="p-1 mt-4">
                        <button class="p-4 rounded-3xl w-full bg-emphasis transition-all text-color hover:text-color-emphasis flex items-center gap-2 justify-between cursor-pointer">
                            <div class="flex items-center [&>*]:-mr-2">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg" size="small" shape="circle" />
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar10.jpg" size="small" shape="circle" />
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar12.jpg" size="small" shape="circle" />
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar9.jpg" size="small" shape="circle" />
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png" size="small" shape="circle" />
                            </div>
                ...
                <div class="border border-surface rounded-3xl p-6">
                    <div class="flex items-start justify-between gap-1">
                        <div class="flex items-center gap-x-2 gap-y-1 flex-wrap flex-1">
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar1.png" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar2.png" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar9.jpg" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg" size="small" shape="circle" />
                            <div class="w-full"></div>
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar13.jpg" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar7.png" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar8.png" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar10.jpg" size="small" shape="circle" />
                            <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar12.jpg" size="small" shape="circle" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex flex-col gap-4">
                            <div class="flex items-center gap-2 justify-between">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar8.png" class="w-9 h-9" shape="circle" />
                                <div class="flex-1">
                                    <div class="text-sm font-medium text-color leading-5">Brook Simmons</div>
                                    <div class="text-sm text-muted-color leading-5 line-clamp-4">brook.sim42@wangsvue.org</div>
                                </div>
                                <Select
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar13.jpg" class="w-9 h-9" shape="circle" />
                                <div class="flex-1">
                                    <div class="text-sm font-medium text-color leading-5">Dianne Russell</div>
                                    <div class="text-sm text-muted-color leading-5 line-clamp-4">di.russ23@wangsvue.org</div>
                                </div>
                                <Select
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar12.jpg" class="w-9 h-9" shape="circle" />
                                <div class="flex-1">
                                    <div class="text-sm font-medium text-color leading-5">Jacob Jones</div>
                                    <div class="text-sm text-muted-color leading-5 line-clamp-4">jac.jon87@wangsvue.org</div>
                                </div>
                                <Select
...
export default {
    ...
    methods: {
        ...
        formatSize(bytes) {
            const k = 1024;
            const dm = 3;
            const sizes = this.$wangsvue.config.locale.fileSizeTypes;
