    ...
    <div class="flex-1 h-full overflow-y-auto overflow-x-clip overflow-hidden flex border border-surface rounded-2xl">
        ...
        <div class="w-8/12 xl:w-6/12 border-x border-surface flex flex-col">
            <div class="flex items-center p-4 gap-7 border-b border-surface">
                <div class="flex items-center">
                    <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar-wangstek.png" class="mr-2 av" size="large" shape="circle" />
                    <div class="flex-1">
                        <div class="text-color leading-6 cursor-pointer hover:text-muted-color-emphasis transition-colors">wangsTek</div>
        ...
        <div class="w-3/12 xl:block hidden min-w-40 py-6 px-3 overflow-auto">
            <div class="flex flex-col items-center justify-center">
                <Avatar image="https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar-wangstek.png" class="w-32 h-32" size="xlarge" shape="circle" />
                <div class="leading-6 font-medium text-color mt-4 w-full text-center">wangsTek</div>
                <div class="leading-5 text-sm text-muted-color mt-1 w-full text-center">@wangstek</div>
...
export default {
    ...
    data() {
        return {
            ...
            chats: [
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg',
                    name: 'Cody Fisher',
                    capName: 'CF',
                    active: true,
                    unreadMessageCount: 8,
                    time: '12.30',
                    lastMessage: "Hey there! I've heard about wangsVue. Any cool tips for getting started?"
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar-wangstek.png',
                    name: 'wangsTek Team',
                    capName: 'PT',
                    active: undefined,
                    unreadMessageCount: 0,
                    time: '11.15',
                    lastMessage: "Let's implement wangsVue. Elevating our UI game! 🚀"
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar2.png',
                    name: 'Jerome Bell',
                    capName: 'JB',
                    active: true,
                    unreadMessageCount: 4,
                    time: '11.15',
                    lastMessage: "Absolutely! wangsVue's documentation is gold—simplifies our UI work."
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar12.jpg',
                    name: 'Robert Fox',
                    capName: 'RF',
                    active: false,
                    unreadMessageCount: 0,
                    time: '11.15',
                    lastMessage: "Interesting! wangsVue sounds amazing. What's your favorite feature?"
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar13.jpg',
                    name: 'Esther Howard',
                    capName: 'EH',
                    active: true,
                    unreadMessageCount: 9,
                    time: '11.15',
                    lastMessage: 'Quick one, team! Anyone using wangsVue for mobile app development?'
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar9.jpg',
                    name: 'Darlene Robertson',
                    capName: 'DR',
                    active: false,
                    unreadMessageCount: 0,
                    time: '11.15',
                    lastMessage: "Just explored wangsVue's themes. Can we talk about those stunning designs? 😍"
                },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar6.png',
                    name: 'Ralph Edwards',
                    capName: 'RE',
                    active: false,
                    unreadMessageCount: 0,
                    time: '11.15',
                    lastMessage: 'wangsVue is a game-changer, right? What are your thoughts, folks?'
                },
                { image: '', name: 'Ronald Richards', capName: 'RR', active: false, unreadMessageCount: 0, time: '11.15', lastMessage: "Jumping in! wangsVue's community forum is buzzing. Any engaging discussions?" },
                { image: '', name: 'Kristin Watson', capName: 'KW', active: false, unreadMessageCount: 0, time: '11.15', lastMessage: 'Sharing a quick win-wangsVue tutorials are leveling up my UI skills. 👩‍💻' },
                {
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar7.png',
                    name: 'Darrell Steward',
                    capName: 'DS',
                    active: false,
                    unreadMessageCount: 0,
                    time: '11.15',
                    lastMessage: "Reflecting on wangsVue's impact on our workflow. What's your take?"
                }
            ],
            chatMessages: [
                { id: 1, attachment: '', name: '', image: '', capName: 'OS', type: 'received', message: "Awesome! What's the standout feature?" },
                { id: 2, attachment: '', name: '', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar8.png', capName: 'A', type: 'received', message: 'wangsVue rocks! Simplifies UI dev with versatile components.' },
                { id: 3, attachment: '', name: '', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg', capName: 'A', type: 'received', message: 'Intriguing! Tell us more about its impact.' },
                {
                    id: 4,
                    attachment: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/message-image.png',
                    name: '',
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar2.png',
                    capName: 'A',
                    type: 'received',
                ...
                { id: 5, attachment: '', name: '', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png', capName: 'A', type: 'sent', message: 'Customizable themes, responsive design – UI excellence!' },
                { id: 6, attachment: '', name: '', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar8.png', capName: 'A', type: 'received', message: 'Love it! Fast-tracking our development is key.' },
                { id: 7, attachment: '', name: '', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar6.png', capName: 'A', type: 'received', message: 'Documentation rocks too – smooth integration for all.' },
                {
                    id: 8,
                    attachment: '',
                    name: '',
                    image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png',
                    capName: 'B',
                    type: 'sent',
                ...
                },
                {
                    ...
                    capName: 'H',
                    type: 'sent',
                    message: "That's great advice. It's amazing how much detail and thought has gone into making wangsVue such a powerful tool for developers."
                }
            ],
            chatMedia: [
                'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/chat-image1.png',
                'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/chat-image2.png',
                'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/chat-image3.png',
                'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/chat-image4.png',
                'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/chat-image5.png'
            ],
            members: [
                { name: 'Robin Jonas', capName: 'RJ', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar2.png' },
                { name: 'Cameron Williamson', capName: 'CW', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar11.jpg' },
                { name: 'Eleanor Pena', capName: 'EP', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar5.png' },
                { name: 'Arlene McCoy', capName: 'AM', image: 'https://www.wangsfaces.org/cdn/wangsvue/images/landing/apps/avatar8.png' },
