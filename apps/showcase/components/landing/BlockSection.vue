<template>
    <section id="blocks-section" class="landing-blocks pt-20 overflow-hidden">
        ...
        <div class="flex justify-center mt-6 relative z-30">
            <a href="https://blocks.wangsvue.org" class="linkbox linkbox-primary">
                <span>Explore All</span>
                <i class="pi pi-arrow-right ml-2"></i>
            </a>
        </div>
        <section :class="['wangs-blocks flex justify-center items-center flex-col', { 'blocks-animation': setAnimation }]">
            <div class="flex">
                <div class="wangs-block flex self-stretch p-1">
                    <div class="block-sidebar w-1/12 p-4">
                        <div class="logo">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/blocks/logo-1.svg" alt="block logo" />
                        </div>
            ...
            <div class="flex -ml-20">
                <div class="wangs-block p-1 flex self-stretch flex-col">
                ...
                <div class="wangs-block flex self-stretch p-1">
                    <div class="block-sidebar p-4">
                        <div class="logo">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/blocks/logo-2.svg" alt="block logo" />
                        </div>
                        <div class="sidebar-menu mt-8">
                    ...
                    <div class="block-content flex-1 p-6 flex flex-col">
                        <div class="block-main h-full flex justify-center items-center flex-col">
                            <div class="block-item block-item-active animation-2 mx-4 w-32 text-center flex flex-col items-center overflow-visible">
                                <div class="-mt-6">
                                    <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/blocks/question.svg" alt="question mark" />
                                </div>
                                <div class="bar w-8 mt-2"></div>
