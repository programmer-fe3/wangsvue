            ...
            <div class="box overflow-hidden z-10 p-8 table-container">
                ...
                >
                    ...
                    <Column field="country.name" header="Country" sortable style="min-width: 14rem">
                        <template #body="{ data }">
                            <img alt="flag" src="https://wangsfaces.org/cdn/wangsvue/images/flag/flag_placeholder.png" :class="`mr-2 flag flag-${data.country.code}`" style="width: 24px" />
                    ...
                    <Column header="Agent" sortable sortField="representative.name" style="min-width: 14rem">
                        <template #body="{ data }">
                            <div class="flex items-center gap-2">
                                <img :alt="data.representative.name" :src="'https://wangsfaces.org/cdn/wangsvue/images/avatar/' + data.representative.image" width="32" />
