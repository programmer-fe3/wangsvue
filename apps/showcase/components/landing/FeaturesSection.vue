<template>
    <section class="landing-features py-20">
        ...
        <p class="section-detail">wangsVue is the most complete solution for your UI requirements.</p>
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-components.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-theme.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-community.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-accessibility.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-support.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-mobile.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-productivity.svg" alt="components icon" class="block mb-4" />
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-3 flex justify-center">
                        <div v-animateonscroll.once="{ enterClass: 'animate-fadein' }" class="box p-6 w-full animate-duration-500">
                            <img src="https://wangsfaces.org/cdn/wangsvue/images/landing/features/icon-ts.svg" alt="components icon" class="block mb-4" />
