        ...
        <div class="absolute left-1/2 top-20 -translate-x-1/2 md:translate-x-0 md:top-1/2 md:-translate-y-1/2 md:left-10 lg:left-20 xl:left-36 z-20 w-[92%] max-w-lg md:w-[26rem] lg:w-[28rem] xl:w-[29rem] rounded-3xl p-7 lg:px-9 lg:py-7">
            ...
            <div class="z-10 relative">
                ...
                <div class="flex items-center gap-4 mt-8">
                    ...
                    >
                    <a
                        :href="templateHeroData.storeHref ?? 'https://www.wangsfaces.org/store/'"
                        target="_blank"
                ...
                <div class="flex items-center gap-4 mt-6">
                    <a class="flex items-center gap-2 text-primary-contrast lg:text-base text-sm" :href="templateHeroData.supportHref ?? 'https://github.com/orgs/wangsfaces/discussions/categories/wangsvue-templates'" target="_blank">
