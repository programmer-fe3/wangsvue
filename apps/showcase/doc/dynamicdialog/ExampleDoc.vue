...
<script setup>
import { markRaw, defineAsyncComponent } from 'vue';
import { useDialog } from 'wangsvue/usedialog';
        ...
        <DataTable :value="products">
            ...
            <Column header="Image">
                <template #body="slotProps">
                    <img :src="'https://wangsfaces.org/cdn/wangsvue/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="w-16" />
                </template>
            </Column>
