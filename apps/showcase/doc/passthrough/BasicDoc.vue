<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>
            ...
            <a href="https://vuejs.org/guide/essentials/class-and-style.html">Vue bindings</a> like arrays, objects and conditionals. Example below styles a Panel component with wangsFlex CSS library.
        </p>
    </DocSectionText>
