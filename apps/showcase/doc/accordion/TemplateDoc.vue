    ...
    <div class="card">
        <Accordion value="0" expandIcon="pi pi-plus" collapseIcon="pi pi-minus">
            <AccordionPanel value="0">
                <AccordionHeader>
                    <span class="flex items-center gap-2 w-full">
                        <Avatar image="https://wangsfaces.org/cdn/wangsvue/images/avatar/amyelsner.png" shape="circle" />
            ...
            <AccordionPanel value="2">
                <AccordionHeader>
                    <span class="flex items-center gap-2 w-full">
                        <Avatar image="https://wangsfaces.org/cdn/wangsvue/images/avatar/ionibowcher.png" shape="circle" />
