...
export default {
    data() {
        return {
            value: '<div>Hello World!</div><div>wangsVue <b>Editor</b> Rocks</div><div><br></div>',
            code: {
                basic: `
<Editor v-model="value" editorStyle="height: 320px">
    <template v-slot:toolbar>
...
const value = ref('<div>Hello World!</div><div>wangsVue <b>Editor</b> Rocks</div><div><br></div>');
<\/script>
`
            }
        };
