<template>
    <DocSectionText v-bind="$attrs">
        <p>Here is the full list of wangsIcons. More icons will be added periodically and you may also <a href="https://github.com/wangsfaces/wangsicons/issues">request new icons</a> at the issue tracker.</p>
    </DocSectionText>
