        ...
        <Timeline :value="events" align="alternate" class="customized-timeline">
            ...
            <template #content="slotProps">
                <Card class="mt-4">
                    ...
                    <template #content>
                        <img v-if="slotProps.item.image" :src="`https://wangsfaces.org/cdn/wangsvue/images/product/${slotProps.item.image}`" :alt="slotProps.item.name" width="200" class="shadow-sm" />
                        <p>
