<template>
    <DocSectionText v-bind="$attrs">
        <p>
            TreeSelect is used as a controlled component with <i>v-model</i> directive along with an <i>options</i> collection. Internally <WangsVueNuxtLink to="/tree">Tree</WangsVueNuxtLink> component is used so the options model is based on
            TreeNode API.
        </p>
