<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/@layer" class="doc-link">MDN</a> to begin with. In styled mode, when the <i>cssLayer</i> option is enabled at theme configuration, wangsVue wraps the built-in style classes under
            the <i>wangsvue</i> cascade layer to make the library styles easy to override. CSS in your app without a layer has the highest CSS specificity, so you'll be able to override styles regardless of the location or how strong a class is
        ...
        <p>
            ...
            the layers, we'd have to write a stronger css or use <i>!important</i> however, with layers, this does not present an issue as your CSS can always override wangsVue with a more straightforward class name such as <i>my-switch-slider</i>.
