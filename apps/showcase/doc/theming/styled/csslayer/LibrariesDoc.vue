<template>
    ...
    <p>
        ...
        separate layers and make sure wangsvue layer comes after the base.
    </p>
    <DocSectionCode :code="code2" hideToggleCode hideStackBlitz />

    <h4>Normalize</h4>
    <p>Normalize is another utility to reset CSS of the standard elements. While importing the CSS file, assign it to a layer and define the layer order with wangsvue coming after the normalized layer.</p>
...
export default {
    data() {
        return {
            code1: {
                basic: `
@layer bootstrap-reboot, wangsvue;
...
`
            ...
            code2: {
                basic: `
@layer tailwind-base, wangsvue, tailwind-utilities;
