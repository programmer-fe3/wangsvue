<template>
    <DocSectionText v-bind="$attrs">
        <p>
            wangsVue is a design agnostic library so unlike some other UI libraries it does not enforce a certain styling such as material design. Styling is decoupled from the components using the themes instead. A theme consists of two parts;
        ...
        <img alt="Architecture" src="https://wangsfaces.org/cdn/wangsvue/images/wangsvue-v4-styled-architecture.png" class="w-full mb-4" />
        ...
        <p class="mb-0">
            ...
            component. By defining your own design tokens as a custom preset, you'll be able to define your own style without touching CSS. Overriding the wangsVue components using style classes is not a best practice and should be the last resort,
