<template>
            ...
            >
                ...
                <Column header="Image">
                    <template #body="slotProps">
                        <img :src="`https://wangsfaces.org/cdn/wangsvue/images/product/${slotProps.data.image}`" :alt="slotProps.data.image" class="rounded" style="width: 64px" />
                    </template>
                </Column>
    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true">
        <div class="flex flex-col gap-6">
            <img v-if="product.image" :src="`https://wangsfaces.org/cdn/wangsvue/images/product/${product.image}`" :alt="product.image" class="block m-auto pb-4" />
            <div>
