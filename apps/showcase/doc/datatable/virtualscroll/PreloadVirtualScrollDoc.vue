<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <WangsVueNuxtLink to="/virtualscroller">VirtualScroller</WangsVueNuxtLink> component is utilized so refer to the API of VirtualScroller for more information about the available options.
        </p>
