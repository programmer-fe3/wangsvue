<template>
    ...
    <div class="card">
        ...
        <Terminal welcomeMessage="Welcome to wangsVue" prompt="wangsvue $" aria-label="wangsVue Terminal Service" />
    </div>
    ...
    data() {
        return {
            code: {
                basic: `
<Terminal
    welcomeMessage="Welcome to wangsVue"
    prompt="wangsvue $"
    aria-label="wangsVue Terminal Service"
/>
`,
                options: `
<template>
