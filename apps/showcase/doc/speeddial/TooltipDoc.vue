<template>
    <DocSectionText v-bind="$attrs">
        <p>Items display a tooltip on hover when a standalone <WangsVueNuxtLink to="/tooltip">Tooltip</WangsVueNuxtLink> is present with a target that matches the items.</p>
    </DocSectionText>
    <div class="card">
