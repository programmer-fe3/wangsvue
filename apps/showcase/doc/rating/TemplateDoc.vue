<template>
    ...
    <div class="card flex justify-center">
        <Rating v-model="value">
            <template #cancelicon>
                <img src="https://wangsfaces.org/cdn/wangsvue/images/rating/cancel.png" height="24" width="24" />
            </template>
            <template #onicon>
                <img src="https://wangsfaces.org/cdn/wangsvue/images/rating/custom-onicon.png" height="24" width="24" />
            </template>
            <template #officon>
                <img src="https://wangsfaces.org/cdn/wangsvue/images/rating/custom-officon.png" height="24" width="24" />
            </template>
        </Rating>
    </div>
