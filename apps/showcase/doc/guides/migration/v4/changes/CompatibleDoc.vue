<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>Old names are deprecated but still functional, migrate to new import paths instead e.g. <i>wangsvue/calendar</i> becomes <i>wangsvue/datepicker</i>.</p>
        ...
        <ul class="flex flex-col gap-2 leading-normal">
            <li><a href="https://github.com/wangsfaces/wangsvue/issues/5426" target="_blank" rel="noopener noreferrer" class="doc-link">#5426</a></li>
            <li><a href="https://github.com/wangsfaces/wangsvue/issues/5437" target="_blank" rel="noopener noreferrer" class="doc-link">#5437</a></li>
        </ul>
    </DocSectionText>
</template>
