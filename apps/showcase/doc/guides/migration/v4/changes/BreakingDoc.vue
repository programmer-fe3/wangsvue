<template>
    <DocSectionText v-bind="$attrs">
        <h4>SASS Themes</h4>
        <p>
            The styled mode theming has been reimplemented from scratch based on an all-new architecture. The <i>theme.css</i> and the <i>wangsvue/resources</i> do not exist anymore, so any imports of these assets needs to be removed. If you had a
        ...
        <ul class="flex flex-col gap-2 leading-normal">
            <li>Imports from <i class="mark">wangsvue/api</i> have been relocated to <i class="mark">@wangsvue/core/api</i>.</li>
        </ul>

        <h4>Removed Files</h4>
        <ul class="flex flex-col gap-2 leading-normal">
            <li>Themes under the <i class="mark">wangsvue/resources</i> path, migration to new styled mode is necessary.</li>
            <li>The legacy Tailwind preset at <i class="mark">wangsvue/passthrough/tailwind</i>, migrate to the <a href="https://tailwind.wangsvue.org" target="_blank" rel="noopener noreferrer" class="doc-link">Tailwind Presets</a> project.</li>
        </ul>
        ...
        <p>
            The experimental PassThrough feature is not production ready, there are changes on the PT section names due to alignment with CSS classes for certain components. If when component element is another wangsVue component <i>pc</i> prefix is
        ...
        <p>
            The <a href="https://tailwind.wangsvue.org" target="_blank" rel="noopener noreferrer" class="doc-link">Tailwind CSS</a> presets for the unstyled mode do not support v4 yet, an update is under development and scheduled for the end of July
            2024.
        </p>
        ...
        <h4>Nuxt Module</h4>
        <p>
            The <a href="https://www.npmjs.com/package/nuxt-wangsvue" target="_blank" rel="noopener noreferrer" class="doc-link">nuxt-wangsvue</a> module has been replaced with the new
            <a href="https://www.npmjs.com/package/@wangsvue/nuxt-module" target="_blank" rel="noopener noreferrer" class="doc-link">@wangsvue/nuxt-module</a>. The old module is still maintained for v3 users.
        </p>
    </DocSectionText>
</template>
