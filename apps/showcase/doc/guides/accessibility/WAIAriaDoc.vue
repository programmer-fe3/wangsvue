<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            datepicker or colorpicker has been improved over the past years many web developers still utilize UI components derived from standard HTML elements created by them or by other projects like wangsVue. These types of components must provide
    ...
    <pre v-code><code>
&lt;input type="checkbox" value="wangs" name="ui" checked&gt;
...
&lt;/div&gt;
    ...
    <div class="doc-section-description mt-4">
        <p>A working sample is the wangsVue checkbox that is tabbable, keyboard accessible and is compliant with a screen reader. Instead of ARIA roles it relies on a hidden native checkbox.</p>
    </div>
