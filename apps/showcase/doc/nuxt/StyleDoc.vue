<template>
    <DocSectionText v-bind="$attrs">
        <p>
            Module is used to configure the wangsVue options, register components, directives and composables. CSS configuration of the styled mode is not included at the moment due to the upcoming enhancements like moving theming to core with CSS
...
export default defineNuxtConfig({
    css: ['wangsvue/resources/themes/aura-dark-green/theme.css']
})
`
            }
        };
