<template>
    ...
    <div class="card flex flex-col items-center gap-4">
        ...
        <div v-if="selectedProduct" class="p-8 bg-surface-0 dark:bg-surface-900 rounded border border-surface-200 dark:border-surface-700">
            <div class="relative">
                <img :src="`https://wangsfaces.org/cdn/wangsvue/images/product/${selectedProduct.image}`" :alt="selectedProduct.name" class="w-full sm:w-80" />
            </div>
            ...
            <DataTable v-model:selection="selectedProduct" :value="products" selectionMode="single" :paginator="true" :rows="5" @row-select="onProductSelect">
                ...
                <Column header="Image">
                    <template #body="slotProps">
                        <img :src="`https://wangsfaces.org/cdn/wangsvue/images/product/${slotProps.data.image}`" :alt="slotProps.data.image" class="w-16 shadow-sm" />
                    </template>
                </Column>
    ...
    <div class="card flex flex-col items-center gap-4">
        ...
        <Popover ref="op" appendTo="body">
            <DataTable v-model:selection="selectedProduct" :value="products" selectionMode="single" :paginator="true" :rows="5" @row-select="onProductSelect">
                ...
                <Column header="Image">
                    <template #body="slotProps">
                        <img :src="\`https://wangsfaces.org/cdn/wangsvue/images/product/\${selectedProduct.image}\`" :alt="slotProps.data.image" class="w-16 shadow-sm" />
                    </template>
                </Column>
                <Column field="price" header="Price" sortable style="min-width: 8rem">
                    <template #body="slotProps">
