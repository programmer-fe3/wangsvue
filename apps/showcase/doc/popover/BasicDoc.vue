        ...
        <Popover ref="op">
            <div class="flex flex-col gap-4 w-[25rem]">
                <div>
                    ...
                    <InputGroup>
                        <InputText value="https://wangsvue.org/12323ff26t2g243g423g234gg52hy25XADXAG3" readonly class="w-[25rem]"></InputText>
                        <InputGroupAddon>
                ...
                <div>
                    ...
                    <ul class="list-none p-0 m-0 flex flex-col gap-4">
                        <li v-for="member in members" :key="member.name" class="flex items-center gap-2">
                            <img :src="`https://wangsfaces.org/cdn/wangsvue/images/avatar/${member.image}`" style="width: 32px" />
                            <div>
