    ...
    <div class="card dock-demo">
        ...
        <div class="dock-window dock-advanced">
            ...
            <Dialog v-model:visible="displayTerminal" header="Terminal" :breakpoints="{ '960px': '50vw' }" :style="{ width: '40vw' }" :maximizable="true">
                <Terminal welcomeMessage="Welcome to wangsVue(cmd: 'date', 'greet {0}' and 'random')" prompt="wangsvue $" />
            </Dialog>
    ...
    data() {
        return {
            ...
            items: [
                {
                    label: 'Finder',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/finder.svg',
                    command: () => {
                ...
                {
                    label: 'Terminal',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/terminal.svg',
                    command: () => {
                ...
                {
                    label: 'App Store',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/appstore.svg',
                    command: () => {
                ...
                {
                    label: 'Safari',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/safari.svg',
                    command: () => {
                ...
                {
                    label: 'Photos',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/photos.svg',
                    command: () => {
                ...
                {
                    label: 'GitHub',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/github.svg'
                },
                {
                    label: 'Trash',
                    icon: 'https://wangsfaces.org/cdn/wangsvue/images/dock/trash.png',
                    command: () => {
...
.dock-demo > .dock-window {
    ...
    height: 450px;
    position: relative;
    background-image: url("https://wangsfaces.org/cdn/wangsvue/images/dock/window.jpg");
...
import { useToast } from 'wangsvue/usetoast';
import TerminalService from 'wangsvue/terminalservice';
import { NodeService } from '@/service/NodeService';
import { PhotoService } from '@/service/PhotoService';
