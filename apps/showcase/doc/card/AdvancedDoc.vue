<template>
    ...
    <div class="mb-4 p-8 flex items-center justify-center">
        <Card style="width: 25rem; overflow: hidden">
            <template #header>
                <img alt="user header" class="w-full" src="https://wangsfaces.org/cdn/wangsvue/images/card-vue.jpg" />
            </template>
...
<template>
    <Card style="width: 25rem; overflow: hidden">
        <template #header>
            <img alt="user header" src="https://wangsfaces.org/cdn/wangsvue/images/usercard.png" />
        </template>
        <template #title>Advanced Card</template>
        <template #subtitle>Card subtitle</template>
        <template #content>
