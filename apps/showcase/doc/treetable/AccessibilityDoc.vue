<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>Paginator is a standalone component used inside the DataTable, refer to the <WangsVueNuxtLink to="/paginator">paginator</WangsVueNuxtLink> for more information about the accessibility features.</p>
