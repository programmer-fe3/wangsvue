<template>
    <DocSectionText v-bind="$attrs">
        ...
        <h3>CSS Layer</h3>
        <p>Enable wangsVue CSS layer and configure the tailwind styles to have higher specificity with layering. This way, <i>!</i> prefix is not required.</p>
...
app.use(wangsVue, {
    theme: {
        ...
        options: {
            cssLayer: {
                name: 'wangsvue',
                order: 'tailwind-base, wangsvue, tailwind-utilities'
            }
        }
    }
 });
