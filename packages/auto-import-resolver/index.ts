import { components, directives, MetaType } from '@wangsvue/metadata';
import type { ComponentResolver, ComponentResolveResult } from 'unplugin-vue-components/types';

export interface wangsVueResolverOptions {
    components?: {
        prefix?: string;
    };
    directives?: {
...
export function wangsVueResolver(options: wangsVueResolverOptions = {}): ComponentResolver[] {
