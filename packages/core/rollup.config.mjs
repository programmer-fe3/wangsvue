...
function addCore() {
    ...
    ENTRY.format.es({ input: process.env.INPUT_DIR + 'config/WangsVue.js', output: process.env.OUTPUT_DIR + 'config/index' });
    ENTRY.format.es({ input: process.env.INPUT_DIR + 'service/WangsVueService.js', output: process.env.OUTPUT_DIR + 'service/index' });
}
