...
export default {
    ...
    beforeCreate() {
        ...
        const _useptInConfig = this.$wangsvueConfig?.pt?.['_usept'];
        const originalValueInConfig = _useptInConfig ? this.$wangsvue?.config?.pt?.originalValue : undefined;
        const valueInConfig = _useptInConfig ? this.$wangsvue?.config?.pt?.value : this.$wangsvue?.config?.pt;
    ...
    methods: {
        ...
        _getPTValue(obj = {}, key = '', params = {}, searchInDefaultPT = true) {
            ...
            const { mergeSections = true, mergeProps: useMergeProps = false } = this._getPropValue('ptOptions') || this.$wangsvueConfig?.ptOptions || {};
        ...
        _usePT(pt, callback, key, params) {
            ...
            if (pt?.hasOwnProperty('_usept')) {
                const { mergeSections = true, mergeProps: useMergeProps = false } = pt['_usept'] || this.$wangsvueConfig?.ptOptions || {};
    ...
    computed: {
        globalPT() {
            return this._getPT(this.$wangsvueConfig?.pt, undefined, (value) => resolve(value, { instance: this }));
        },
        defaultPT() {
            return this._getPT(this.$wangsvueConfig?.pt, undefined, (value) => this._getOptionValue(value, this.$name, { ...this.$params }) || resolve(value, { ...this.$params }));
        },
        isUnstyled() {
            return this.unstyled !== undefined ? this.unstyled : this.$wangsvueConfig?.unstyled;
        },
        $theme() {
            return this.$wangsvueConfig?.theme;
        },
        $style() {
        ...
        $styleOptions() {
            return { nonce: this.$wangsvueConfig?.csp?.nonce };
        },
        $wangsvueConfig() {
            return this.$wangsvue?.config;
        },
        $name() {
