...
export function useStyle(css, options = {}) {
    ...
    const load = (_css, _props = {}) => {
        ...
        styleRef.value = document.querySelector(`style[data-wangsvue-style-id="${_name}"]`) || document.getElementById(_id) || document.createElement('style');
        ...
        if (!styleRef.value.isConnected) {
            ...
            setAttribute(styleRef.value, 'data-wangsvue-style-id', _name);
