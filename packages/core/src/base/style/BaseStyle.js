...
import { useStyle } from '@wangsvue/core/usestyle';
...
export default {
    ...
    getStyleSheet(extendedCSS = '', props = {}) {
        if (this.css) {
            ...
            return `<style type="text/css" data-wangsvue-style-id="${this.name}" ${_props}>${_style}</style>`;
        }
    ...
    getThemeStyleSheet(params, props = {}) {
        ...
        if (this.theme) {
            ...
            css.push(`<style type="text/css" data-wangsvue-style-id="${name}" ${_props}>${_style}</style>`);
        }
