...
const INLINE_EXTERNALS = [/@wangsvue\/core\/.*/];
...
const ALIAS_ENTRIES = [
    ...
    { find: '@wangsvue/icons/baseicon/style', replacement: path.resolve(__dirname, './src/baseicon/style/BaseIconStyle.js') },
    { find: '@wangsvue/icons/baseicon', replacement: path.resolve(__dirname, './src/baseicon/BaseIcon.vue') }
];
