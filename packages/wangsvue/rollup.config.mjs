...
const INLINE_EXTERNALS = [/@wangsvue\/core\/.*/, /@wangsvue\/icons\/.*/, '@primeuix/styled', /@primeuix\/utils\/.*/];
...
const ALIAS_ENTRIES = [
    ...
    // @todo - Remove
    { find: '@wangsvue/core/api', replacement: path.resolve(__dirname, '../core/src/api/Api.js') },
    { find: '@wangsvue/core/base/style', replacement: path.resolve(__dirname, '../core/src/base/style/BaseStyle.js') },
    { find: '@wangsvue/core/base', replacement: path.resolve(__dirname, '../core/src/base/Base.js') },
    { find: '@wangsvue/core/basecomponent/style', replacement: path.resolve(__dirname, '../core/src/basecomponent/style/BaseComponentStyle.js') },
    { find: '@wangsvue/core/basecomponent', replacement: path.resolve(__dirname, '../core/src/basecomponent/BaseComponent.vue') },
    { find: '@wangsvue/core/basedirective', replacement: path.resolve(__dirname, '../core/src/basedirective/BaseDirective.js') },
    { find: '@wangsvue/core/config', replacement: path.resolve(__dirname, '../core/src/config/WangsVue.js') },
    { find: '@wangsvue/core/service', replacement: path.resolve(__dirname, '../core/src/service/WangsVueService.js') },
    { find: '@wangsvue/core/usestyle', replacement: path.resolve(__dirname, '../core/src/usestyle/UseStyle.js') },
    { find: '@wangsvue/core/utils', replacement: path.resolve(__dirname, '../core/src/utils/Utils.js') },
    { find: '@wangsvue/core', replacement: path.resolve(__dirname, '../core/src/index.js') },
    { find: '@wangsvue/icons/baseicon/style', replacement: path.resolve(__dirname, '../icons/src/baseicon/style/BaseIconStyle.js') },
    { find: '@wangsvue/icons/baseicon', replacement: path.resolve(__dirname, '../icons/src/baseicon/BaseIcon.vue') }
];
...
function addLibrary() {
    ENTRY.format.umd({ name: 'wangsVue', input: process.env.INPUT_DIR + 'wangsvue.js', output: process.env.OUTPUT_DIR + 'umd/wangsvue', minify: true });
}
