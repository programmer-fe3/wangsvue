 ...
 *
 * [Live Demo](https://www.wangsvue.org/inputnumber/)
 *
 * @module inputnumber
 *
 */
import type { DefineComponent, DesignToken, EmitFn, GlobalComponentConstructor, Nullable, PassThrough } from '@wangsvue/core';
