...
import WindowMaximizeIcon from '@wangsvue/icons/windowmaximize';
import WindowMinimizeIcon from '@wangsvue/icons/windowminimize';
...
export default {
    ...
    methods: {
        ...
        onEnter() {
            ...
            if (this.autoZIndex) {
                ZIndex.set('modal', this.mask, this.baseZIndex + this.$wangsvue.config.zIndex.modal);
            }
        },
        onBeforeLeave() {
            if (this.modal) {
