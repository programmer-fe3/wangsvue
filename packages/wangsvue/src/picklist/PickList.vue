...
import AngleDoubleDownIcon from '@wangsvue/icons/angledoubledown';
import AngleDoubleLeftIcon from '@wangsvue/icons/angledoubleleft';
import AngleDoubleRightIcon from '@wangsvue/icons/angledoubleright';
import AngleDoubleUpIcon from '@wangsvue/icons/angledoubleup';
import AngleDownIcon from '@wangsvue/icons/angledown';
import AngleLeftIcon from '@wangsvue/icons/angleleft';
import AngleRightIcon from '@wangsvue/icons/angleright';
import AngleUpIcon from '@wangsvue/icons/angleup';
import Button from 'wangsvue/button';
import Listbox from 'wangsvue/listbox';
    ...
    methods: {
        ...
        createStyle() {
            if (!this.styleElement && !this.isUnstyled) {
                ...
                setAttribute(this.styleElement, 'nonce', this.$wangsvue?.config?.csp?.nonce);
...
`;
    ...
    computed: {
        ...
        moveUpAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveUp : undefined;
        },
        moveTopAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveTop : undefined;
        },
        moveDownAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveDown : undefined;
        },
        moveBottomAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveBottom : undefined;
        },
        moveToTargetAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveToTarget : undefined;
        },
        moveAllToTargetAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveAllToTarget : undefined;
        },
        moveToSourceAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveToSource : undefined;
        },
        moveAllToSourceAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.moveAllToSource : undefined;
        }
    },
    components: {
        Listbox,
