    ...
    methods: {
        ...
        createStyle() {
            if (!this.carouselStyle) {
                ...
                setAttribute(this.carouselStyle, 'nonce', this.$wangsvue?.config?.csp?.nonce);
        ...
        ariaSlideNumber(value) {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.slideNumber.replace(/{slideNumber}/g, value) : undefined;
        },
        ariaPageLabel(value) {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.pageLabel.replace(/{page}/g, value) : undefined;
        }
    },
    computed: {
        totalIndicators() {
        ...
        ariaSlideLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.slide : undefined;
        },
        ariaPrevButtonLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.prevPageLabel : undefined;
        },
        ariaNextButtonLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.nextPageLabel : undefined;
        },
        attributeSelector() {
        ...
        emptyMessageText() {
            return this.$wangsvue.config?.locale?.emptyMessage || '';
        }
    },
    components: {
        Button,
