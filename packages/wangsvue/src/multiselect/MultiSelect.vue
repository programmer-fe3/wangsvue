...
import { FilterService } from '@wangsvue/core/api';
...
import SearchIcon from '@wangsvue/icons/search';
import SpinnerIcon from '@wangsvue/icons/spinner';
import TimesIcon from '@wangsvue/icons/times';
import Checkbox from 'wangsvue/checkbox';
import Chip from 'wangsvue/chip';
import IconField from 'wangsvue/iconfield';
import InputIcon from 'wangsvue/inputicon';
...
import VirtualScroller from 'wangsvue/virtualscroller';
...
export default {
    ...
    methods: {
        ...
        getSelectedItemsLabel() {
            let pattern = /{(.*?)}/;
            const selectedItemsLabel = this.selectedItemsLabel || this.$wangsvue.config.locale.selectionMessage;
    ...
    computed: {
        ...
        filterMessageText() {
            return this.filterMessage || this.$wangsvue.config.locale.searchMessage || '';
        },
        emptyFilterMessageText() {
            return this.emptyFilterMessage || this.$wangsvue.config.locale.emptySearchMessage || this.$wangsvue.config.locale.emptyFilterMessage || '';
        },
        emptyMessageText() {
            return this.emptyMessage || this.$wangsvue.config.locale.emptyMessage || '';
        },
        selectionMessageText() {
            return this.selectionMessage || this.$wangsvue.config.locale.selectionMessage || '';
        },
        emptySelectionMessageText() {
            return this.emptySelectionMessage || this.$wangsvue.config.locale.emptySelectionMessage || '';
        },
        selectedMessageText() {
        ...
        toggleAllAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria[this.allSelected ? 'selectAll' : 'unselectAll'] : undefined;
        },
        closeAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.close : undefined;
        },
        listAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.listLabel : undefined;
        },
