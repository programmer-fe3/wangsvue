...
import { ConnectedOverlayScrollHandler } from '@wangsvue/core/utils';
    ...
    computed: {
        ...
        acceptLabel() {
            if (this.confirmation) {
                ...
                return confirmation.acceptLabel || confirmation.acceptProps?.label || this.$wangsvue.config.locale.accept;
            }

            return this.$wangsvue.config.locale.accept;
        },
        rejectLabel() {
            if (this.confirmation) {
                const confirmation = this.confirmation;

                return confirmation.rejectLabel || confirmation.rejectProps?.label || this.$wangsvue.config.locale.reject;
            }

            return this.$wangsvue.config.locale.reject;
        },
        acceptIcon() {
