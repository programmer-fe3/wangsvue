...
import EyeIcon from '@wangsvue/icons/eye';
import RefreshIcon from '@wangsvue/icons/refresh';
import SearchMinusIcon from '@wangsvue/icons/searchminus';
import SearchPlusIcon from '@wangsvue/icons/searchplus';
import TimesIcon from '@wangsvue/icons/times';
import UndoIcon from '@wangsvue/icons/undo';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndex.set('modal', this.mask, this.$wangsvue.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
