...
<script>
import { FilterOperator } from '@wangsvue/core/api';
...
import FilterIcon from '@wangsvue/icons/filter';
import FilterSlashIcon from '@wangsvue/icons/filterslash';
import PlusIcon from '@wangsvue/icons/plus';
import TrashIcon from '@wangsvue/icons/trash';
import Button from 'wangsvue/button';
import FocusTrap from 'wangsvue/focustrap';
import OverlayEventBus from 'wangsvue/overlayeventbus';
import Portal from 'wangsvue/portal';
import Select from 'wangsvue/select';
    ...
    computed: {
        ...
        matchModes() {
            return (
                ...
                this.$wangsvue.config.filterMatchModeOptions[this.type].map((key) => {
                    return { label: this.$wangsvue.config.locale[key], value: key };
                })
            );
        },
        isShowMatchModes() {
        ...
        operatorOptions() {
            return [
                { label: this.$wangsvue.config.locale.matchAll, value: FilterOperator.AND },
                { label: this.$wangsvue.config.locale.matchAny, value: FilterOperator.OR }
            ];
        },
        noFilterLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.noFilter : undefined;
        },
        isShowOperator() {
        ...
        removeRuleButtonLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.removeRule : undefined;
        },
        addRuleButtonLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.addRule : undefined;
        },
        isShowAddConstraint() {
            return this.showAddButton && this.filters[this.field].operator && this.fieldConstraints && this.fieldConstraints.length < this.maxConstraints;
        },
        clearButtonLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.clear : undefined;
        },
        applyButtonLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.apply : undefined;
        },
        columnFilterButtonAriaLabel() {
            return this.$wangsvue.config.locale ? (this.overlayVisible ? this.$wangsvue.config.locale.showFilterMenu : this.$wangsvue.config.locale.hideFilterMenu) : undefined;
        },
        filterOperatorAriaLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.filterOperator : undefined;
        },
        filterRuleAriaLabel() {
            return this.$wangsvue.config.locale ? this.$wangsvue.config.locale.filterConstraint : undefined;
        },
