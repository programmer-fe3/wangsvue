...
import SortAltIcon from '@wangsvue/icons/sortalt';
import SortAmountDownIcon from '@wangsvue/icons/sortamountdown';
import SortAmountUpAltIcon from '@wangsvue/icons/sortamountupalt';
import Badge from 'wangsvue/badge';
