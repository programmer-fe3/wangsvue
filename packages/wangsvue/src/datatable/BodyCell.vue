...
import { getVNodeProp } from '@wangsvue/core/utils';
import BarsIcon from '@wangsvue/icons/bars';
...
import PencilIcon from '@wangsvue/icons/pencil';
...
export default {
    ...
    computed: {
        ...
        expandButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? (this.isRowExpanded ? this.$wangsvue.config.locale.aria.expandRow : this.$wangsvue.config.locale.aria.collapseRow) : undefined;
        },
        initButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.editRow : undefined;
        },
        saveButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.saveEdit : undefined;
        },
        cancelButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.cancelEdit : undefined;
        }
    },
    components: {
