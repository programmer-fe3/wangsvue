...
export default {
    ...
    computed: {
        checkboxAriaLabel() {
            return this.$wangsvue.config.locale.aria ? (this.checked ? this.$wangsvue.config.locale.aria.selectRow : this.$wangsvue.config.locale.aria.unselectRow) : undefined;
        }
    },
    components: {
        CheckIcon,
