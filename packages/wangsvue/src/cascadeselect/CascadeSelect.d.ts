 ...
 *
 * [Live Demo](https://www.wangsvue.org/cascadeselect/)
 *
...
export interface CascadeSelectProps {
    ...
    /**
     * Text to be displayed when there are no options available. Defaults to value from wangsVue locale configuration.
