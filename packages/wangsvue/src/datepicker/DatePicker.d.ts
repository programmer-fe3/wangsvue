 ...
 *
 * [Live Demo](https://www.wangsvue.org/datepicker/)
 *
 * @module datepicker
 *
 */
...
import type { ButtonPassThroughOptions, ButtonProps } from 'wangsvue/button';
...
export interface DatePickerProps {
    ...
    /**
     * Format of the date. Defaults to wangsVue Locale configuration.
     */
 ...
 *
 * [Live Demo](https://www.wangsvue.org/calendar/)
 * --- ---
