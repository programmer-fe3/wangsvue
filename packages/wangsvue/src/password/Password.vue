...
import EyeSlashIcon from '@wangsvue/icons/eyeslash';
...
export default {
    ...
    computed: {
        ...
        weakText() {
            return this.weakLabel || this.$wangsvue.config.locale.weak;
        },
        mediumText() {
            return this.mediumLabel || this.$wangsvue.config.locale.medium;
        },
        strongText() {
            return this.strongLabel || this.$wangsvue.config.locale.strong;
        },
        promptText() {
            return this.promptLabel || this.$wangsvue.config.locale.passwordPrompt;
        },
        overlayUniqueId() {
