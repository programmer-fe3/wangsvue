 ...
 *
 * [Live Demo](https://www.wangsvue.org/password/)
 *
 * @module password
 *
 */
...
export interface PasswordProps extends InputHTMLAttributes {
    ...
    /**
     * Text to prompt password entry. Defaults to wangsVue Locale configuration.
     */
    ...
    /**
     * Text for a weak password. Defaults to wangsVue Locale configuration.
     */
    weakLabel?: string | undefined;
    /**
     * Text for a medium password. Defaults to wangsVue Locale configuration.
     */
    mediumLabel?: string | undefined;
    /**
     * Text for a strong password. Defaults to wangsVue Locale configuration.
     */
