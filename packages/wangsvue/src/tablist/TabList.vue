...
export default {
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$wangsvue.config.locale.aria ? this.$wangsvue.config.locale.aria.next : undefined;
        }
    },
    components: {
        ChevronLeftIcon,
