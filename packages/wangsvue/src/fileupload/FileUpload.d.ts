 ...
 *
 * [Live Demo](https://www.wangsvue.org/fileupload/)
 *
 * @module fileupload
 *
 */
...
export interface FileUploadProps {
    ...
    /**
     * Label of the choose button. Defaults to wangsVue Locale configuration.
     */
    chooseLabel?: string | undefined;
    /**
     * Label of the upload button. Defaults to wangsVue Locale configuration.
     */
    uploadLabel?: string | undefined;
    /**
     * Label of the cancel button. Defaults to wangsVue Locale configuration.
     * @defaultValue Cancel
     */
    cancelLabel?: string | undefined;
    /**
     * Whether to use the default upload or a manual implementation defined in uploadHandler callback. Defaults to wangsVue Locale configuration.
     */
