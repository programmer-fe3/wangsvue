...
import type { CheckboxPassThroughOptionType } from 'wangsvue/checkbox';
import type { DataTablePassThroughOptions } from 'wangsvue/datatable';
import type { PassThroughOptions } from 'wangsvue/passthrough';
import type { RadioButtonPassThroughOptionType } from 'wangsvue/radiobutton';
import type { SelectPassThroughOptionType } from 'wangsvue/select';
import type { VirtualScrollerLoaderOptions } from 'wangsvue/virtualscroller';
...
export interface ColumnProps {
    ...
    /**
     * Type of data. It's value is related to wangsVue.filterMatchModeOptions config.
     */
 ...
 *
 * [Live Demo](https://www.wangsvue.org/Column/)
 * --- ---
