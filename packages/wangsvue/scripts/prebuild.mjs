...
let umd = {
    ...
    exports: [
        `// API
export * from '@wangsvue/core';

// BaseIcon
export { default as BaseIcon } from '@wangsvue/icons/baseicon';
export { default as BaseIconStyle } from '@wangsvue/icons/baseicon/style';
...
// UMD
fs.writeFileSync(INPUT_DIR + 'wangsvue.js', umd.exports.join(''));
