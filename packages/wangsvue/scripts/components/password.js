const PasswordProps = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Text to prompt password entry. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'mediumRegex',
        type: 'string',
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Text for a weak password. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'mediumLabel',
        type: 'string',
        default: 'null',
        description: 'Text for a medium password. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'strongLabel',
        type: 'string',
        default: 'null',
        description: 'Text for a strong password. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'feedback',
        type: 'boolean',
