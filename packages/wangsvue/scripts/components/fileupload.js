const FileUploadProps = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Label of the choose button. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'uploadLabel',
        type: 'string',
        default: 'Upoad',
        description: 'Label of the upload button. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'cancelLabel',
        type: 'string',
        default: 'Cancel',
        description: 'Label of the cancel button. Defaults to wangsVue Locale configuration.'
    },
    {
        name: 'customUpload',
        type: 'boolean',
